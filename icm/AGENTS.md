...
- Structuring/restructuring a workspace, repo, or process into an
  agent-runnable folder pipeline → `instructions/ICM_ARCHITECT.md`.
- Mobile dashboard audit / premium phone-first UX upgrade of an existing
  dashboard → `instructions/MOBILE_DASHBOARD_AUDIT.md`.
