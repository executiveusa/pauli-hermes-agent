...
(152 lines) predates this one's ``_lookup_user_declared_supports_vision``
helper (204 lines total); this vendor's paired test file,
tests/tools/test_computer_use_vision_routing.py, exercises the same test
names the fork's prior test file had — no fork-specific vision-routing
test coverage was dropped.
