...
openspec/changes/hermes-upstream-gap-map). Excluded from gap #1's PR #152
because it exercises the real `tools/computer_use/browser_route.py`
(vendored in this PR); gap #1 shipped an inert stub there. Its fixture,
``tests/fixtures/cua_driver_0_9_tools_list.json``, was vendored alongside
it (also verbatim). Only this note was added.
"""
