...
pending the real `tools/computer_use/permissions.py` (vendored in this
PR); the Pauli approval-callback hook this file exercises indirectly via
`tools.approval.is_approval_bypass_active_for_session` is unchanged. Only
this note was added.
"""
